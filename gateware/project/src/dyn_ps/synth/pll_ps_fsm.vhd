...
entity pll_ps_fsm is
   ...
   port (
      ...
      ps_cnt            : in std_logic_vector(cntsel_width-1 downto 0); 
      ...
      ps_ctrl_cnt       : out std_logic_vector(cntsel_width-1 downto 0);
...
signal ps_cnt_reg                      : std_logic_vector(cntsel_width-1 downto 0);
