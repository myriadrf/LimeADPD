...
# ACDS 18.0 614 win32 2018.10.31.09:41:33
...
# ----------------------------------------
# If rx_pll is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/rx_pll.vho"
fi
