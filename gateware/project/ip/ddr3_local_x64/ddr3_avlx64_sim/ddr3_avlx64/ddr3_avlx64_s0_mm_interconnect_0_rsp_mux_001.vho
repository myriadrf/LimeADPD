...
--synthesis_resources = 
 ...
 ENTITY  ddr3_avlx64_s0_mm_interconnect_0_rsp_mux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END ddr3_avlx64_s0_mm_interconnect_0_rsp_mux_001;

 ARCHITECTURE RTL OF ddr3_avlx64_s0_mm_interconnect_0_rsp_mux_001 IS
 ...
 BEGIN
	...
	src_channel <= ( sink0_channel(3 DOWNTO 0));
	src_data <= ( sink0_data(93 DOWNTO 0));
	src_endofpacket <= sink0_endofpacket;
	src_startofpacket <= sink0_startofpacket;
	src_valid <= sink0_valid;

 END RTL; --ddr3_avlx64_s0_mm_interconnect_0_rsp_mux_001
