...
--synthesis_resources = 
 ...
 ENTITY  ddr3_avlx64_s0_mm_interconnect_0_router_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END ddr3_avlx64_s0_mm_interconnect_0_router_003;

 ARCHITECTURE RTL OF ddr3_avlx64_s0_mm_interconnect_0_router_003 IS
	 ...
	 SIGNAL  s_wire_ddr3_avlx64_s0_mm_interconnect_0_router_003_always0_8_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	wire_w286w(0) <= NOT s_wire_ddr3_avlx64_s0_mm_interconnect_0_router_003_always0_8_dataout;
	wire_w_lg_w_sink_data_range3w4w(0) <= NOT wire_w_sink_data_range3w(0);
	s_wire_ddr3_avlx64_s0_mm_interconnect_0_router_003_always0_8_dataout <= wire_w_lg_w_sink_data_range1w6w(0);
	sink_ready <= src_ready;
	src_channel <= ( "0" & "0" & s_wire_ddr3_avlx64_s0_mm_interconnect_0_router_003_always0_8_dataout & wire_w286w);
	src_data <= ( sink_data(93 DOWNTO 0));
	src_endofpacket <= sink_endofpacket;
	src_startofpacket <= sink_startofpacket;
	src_valid <= sink_valid;
	wire_w_sink_data_range1w(0) <= sink_data(59);
	wire_w_sink_data_range2w(0) <= sink_data(79);
	wire_w_sink_data_range3w(0) <= sink_data(80);

 END RTL; --ddr3_avlx64_s0_mm_interconnect_0_router_003
