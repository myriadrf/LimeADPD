...
entity ddr3_avlx64_s0 is
	port (
		...
		capture_strobe_tracking : in  std_logic_vector(1 downto 0)  := (others => '0'); --                 .capture_strobe_tracking
...
end entity ddr3_avlx64_s0;

architecture rtl of ddr3_avlx64_s0 is
	...
	component ddr3_avlx64_s0_mm_interconnect_0 is
		port (
	...
	end component ddr3_avlx64_s0_mm_interconnect_0;

	component ddr3_avlx64_s0_irq_mapper is
		port (
			clk        : in  std_logic                     := 'X'; -- clk
			reset      : in  std_logic                     := 'X'; -- reset
			sender_irq : out std_logic_vector(31 downto 0)         -- irq
		);
	end component ddr3_avlx64_s0_irq_mapper;
...
begin
	...
	sequencer_mem : component altera_mem_if_sequencer_mem_no_ifdef_params
		generic map (
			...
			AVL_SYMBOL_WIDTH => 8,
			MEM_SIZE         => 12288,
			INIT_FILE        => "ddr3_avlx64_s0_sequencer_mem.hex",
			RAM_BLOCK_TYPE   => "AUTO"
		)
		port map (
	...
	mm_interconnect_0 : component ddr3_avlx64_s0_mm_interconnect_0
		port map (
	...
	irq_mapper : component ddr3_avlx64_s0_irq_mapper
		port map (
			clk        => avl_clk,                       --       clk.clk
...
end architecture rtl; -- of ddr3_avlx64_s0
