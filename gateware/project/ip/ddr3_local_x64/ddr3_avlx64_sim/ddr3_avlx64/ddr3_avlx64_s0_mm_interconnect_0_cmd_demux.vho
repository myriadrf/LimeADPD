...
--synthesis_resources = 
 ...
 ENTITY  ddr3_avlx64_s0_mm_interconnect_0_cmd_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (93 DOWNTO 0);
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (93 DOWNTO 0);
		 ...
		 src3_data	:	OUT  STD_LOGIC_VECTOR (93 DOWNTO 0);
		 src3_endofpacket	:	OUT  STD_LOGIC;
		 src3_ready	:	IN  STD_LOGIC;
		 src3_startofpacket	:	OUT  STD_LOGIC;
		 src3_valid	:	OUT  STD_LOGIC
	 ); 
 END ddr3_avlx64_s0_mm_interconnect_0_cmd_demux;

 ARCHITECTURE RTL OF ddr3_avlx64_s0_mm_interconnect_0_cmd_demux IS
 ...
 END RTL; --ddr3_avlx64_s0_mm_interconnect_0_cmd_demux
