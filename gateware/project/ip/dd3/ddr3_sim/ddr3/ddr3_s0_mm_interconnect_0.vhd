...
entity ddr3_s0_mm_interconnect_0 is
	port (
...
end entity ddr3_s0_mm_interconnect_0;

architecture rtl of ddr3_s0_mm_interconnect_0 is
	...
	component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo is
		port (
			clk               : in  std_logic                     := 'X';             -- clk
			reset             : in  std_logic                     := 'X';             -- reset
	...
	end component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo;

	component ddr3_s0_mm_interconnect_0_router is
		port (
	...
	end component ddr3_s0_mm_interconnect_0_router;

	component ddr3_s0_mm_interconnect_0_router_001 is
		port (
			sink_ready         : out std_logic;                                        -- ready
			sink_valid         : in  std_logic                     := 'X';             -- valid
			sink_data          : in  std_logic_vector(93 downto 0) := (others => 'X'); -- data
	...
	end component ddr3_s0_mm_interconnect_0_router_001;

	component ddr3_s0_mm_interconnect_0_router_002 is
		port (
			sink_ready         : out std_logic;                                        -- ready
			sink_valid         : in  std_logic                     := 'X';             -- valid
			sink_data          : in  std_logic_vector(93 downto 0) := (others => 'X'); -- data
	...
	end component ddr3_s0_mm_interconnect_0_router_002;

	component ddr3_s0_mm_interconnect_0_router_003 is
		port (
			sink_ready         : out std_logic;                                        -- ready
			sink_valid         : in  std_logic                     := 'X';             -- valid
			sink_data          : in  std_logic_vector(93 downto 0) := (others => 'X'); -- data
	...
	end component ddr3_s0_mm_interconnect_0_router_003;

	component ddr3_s0_mm_interconnect_0_cmd_demux is
		port (
			clk                : in  std_logic                     := 'X';             -- clk
			reset              : in  std_logic                     := 'X';             -- reset
			sink_ready         : out std_logic;                                        -- ready
	...
	end component ddr3_s0_mm_interconnect_0_cmd_demux;

	component ddr3_s0_mm_interconnect_0_cmd_demux_001 is
		port (
			clk                : in  std_logic                     := 'X';             -- clk
			reset              : in  std_logic                     := 'X';             -- reset
			sink_ready         : out std_logic;                                        -- ready
	...
	end component ddr3_s0_mm_interconnect_0_cmd_demux_001;

	component ddr3_s0_mm_interconnect_0_cmd_mux is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component ddr3_s0_mm_interconnect_0_cmd_mux;

	component ddr3_s0_mm_interconnect_0_cmd_mux_001 is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component ddr3_s0_mm_interconnect_0_cmd_mux_001;

	component ddr3_s0_mm_interconnect_0_rsp_demux_001 is
		port (
			clk                : in  std_logic                     := 'X';             -- clk
			reset              : in  std_logic                     := 'X';             -- reset
			sink_ready         : out std_logic;                                        -- ready
	...
	end component ddr3_s0_mm_interconnect_0_rsp_demux_001;

	component ddr3_s0_mm_interconnect_0_rsp_mux is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component ddr3_s0_mm_interconnect_0_rsp_mux;

	component ddr3_s0_mm_interconnect_0_rsp_mux_001 is
		port (
			clk                 : in  std_logic                     := 'X';             -- clk
			reset               : in  std_logic                     := 'X';             -- reset
			src_ready           : in  std_logic                     := 'X';             -- ready
	...
	end component ddr3_s0_mm_interconnect_0_rsp_mux_001;

	component ddr3_s0_mm_interconnect_0_avalon_st_adapter is
		generic (
	...
	end component ddr3_s0_mm_interconnect_0_avalon_st_adapter;

	component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_translator is
		generic (
	...
	end component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_translator;

	component ddr3_s0_mm_interconnect_0_sequencer_mem_s1_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component ddr3_s0_mm_interconnect_0_sequencer_mem_s1_translator;

	component ddr3_s0_mm_interconnect_0_sequencer_scc_mgr_inst_avl_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component ddr3_s0_mm_interconnect_0_sequencer_scc_mgr_inst_avl_translator;

	component ddr3_s0_mm_interconnect_0_sequencer_reg_file_inst_avl_translator is
		generic (
			AV_ADDRESS_W                   : integer := 30;
			AV_DATA_W                      : integer := 32;
			UAV_DATA_W                     : integer := 32;
	...
	end component ddr3_s0_mm_interconnect_0_sequencer_reg_file_inst_avl_translator;

	component ddr3_s0_mm_interconnect_0_cpu_inst_data_master_translator is
		generic (
	...
	end component ddr3_s0_mm_interconnect_0_cpu_inst_data_master_translator;

	component ddr3_s0_mm_interconnect_0_cpu_inst_instruction_master_translator is
		generic (
			AV_ADDRESS_W                : integer := 32;
			AV_DATA_W                   : integer := 32;
			AV_BURSTCOUNT_W             : integer := 4;
	...
	end component ddr3_s0_mm_interconnect_0_cpu_inst_instruction_master_translator;
...
begin
	...
	cpu_inst_data_master_translator : component ddr3_s0_mm_interconnect_0_cpu_inst_data_master_translator
		generic map (
			AV_ADDRESS_W                => 20,
			AV_DATA_W                   => 32,
			AV_BURSTCOUNT_W             => 1,
	...
	cpu_inst_instruction_master_translator : component ddr3_s0_mm_interconnect_0_cpu_inst_instruction_master_translator
		generic map (
			AV_ADDRESS_W                => 17,
			AV_DATA_W                   => 32,
			AV_BURSTCOUNT_W             => 1,
	...
	hphy_bridge_s0_translator : component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_translator
		generic map (
			AV_ADDRESS_W                   => 16,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	sequencer_mem_s1_translator : component ddr3_s0_mm_interconnect_0_sequencer_mem_s1_translator
		generic map (
			AV_ADDRESS_W                   => 12,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	sequencer_scc_mgr_inst_avl_translator : component ddr3_s0_mm_interconnect_0_sequencer_scc_mgr_inst_avl_translator
		generic map (
			AV_ADDRESS_W                   => 13,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	sequencer_reg_file_inst_avl_translator : component ddr3_s0_mm_interconnect_0_sequencer_reg_file_inst_avl_translator
		generic map (
			AV_ADDRESS_W                   => 4,
			AV_DATA_W                      => 32,
			UAV_DATA_W                     => 32,
	...
	hphy_bridge_s0_agent_rsp_fifo : component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo
		port map (
			clk               => avl_clk_out_clk_clk,                             --       clk.clk
			reset             => cpu_inst_reset_n_reset_bridge_in_reset_reset,    -- clk_reset.reset
	...
	sequencer_mem_s1_agent_rsp_fifo : component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo
		port map (
			clk               => avl_clk_out_clk_clk,                               --       clk.clk
			reset             => cpu_inst_reset_n_reset_bridge_in_reset_reset,      -- clk_reset.reset
	...
	sequencer_scc_mgr_inst_avl_agent_rsp_fifo : component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo
		port map (
			clk               => avl_clk_out_clk_clk,                                         --       clk.clk
			reset             => cpu_inst_reset_n_reset_bridge_in_reset_reset,                -- clk_reset.reset
	...
	sequencer_reg_file_inst_avl_agent_rsp_fifo : component ddr3_s0_mm_interconnect_0_hphy_bridge_s0_agent_rsp_fifo
		port map (
			clk               => avl_clk_out_clk_clk,                                          --       clk.clk
			reset             => cpu_inst_reset_n_reset_bridge_in_reset_reset,                 -- clk_reset.reset
	...
	router : component ddr3_s0_mm_interconnect_0_router
		port map (
	...
	router_001 : component ddr3_s0_mm_interconnect_0_router_001
		port map (
	...
	router_002 : component ddr3_s0_mm_interconnect_0_router_002
		port map (
	...
	router_003 : component ddr3_s0_mm_interconnect_0_router_003
		port map (
	...
	router_004 : component ddr3_s0_mm_interconnect_0_router_002
		port map (
	...
	router_005 : component ddr3_s0_mm_interconnect_0_router_002
		port map (
	...
	cmd_demux : component ddr3_s0_mm_interconnect_0_cmd_demux
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_demux_001 : component ddr3_s0_mm_interconnect_0_cmd_demux_001
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux : component ddr3_s0_mm_interconnect_0_cmd_mux
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_001 : component ddr3_s0_mm_interconnect_0_cmd_mux_001
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_002 : component ddr3_s0_mm_interconnect_0_cmd_mux
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	cmd_mux_003 : component ddr3_s0_mm_interconnect_0_cmd_mux
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux : component ddr3_s0_mm_interconnect_0_cmd_demux_001
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_001 : component ddr3_s0_mm_interconnect_0_rsp_demux_001
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_002 : component ddr3_s0_mm_interconnect_0_cmd_demux_001
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_demux_003 : component ddr3_s0_mm_interconnect_0_cmd_demux_001
		port map (
			clk                => avl_clk_out_clk_clk,                          --       clk.clk
			reset              => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_mux : component ddr3_s0_mm_interconnect_0_rsp_mux
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	rsp_mux_001 : component ddr3_s0_mm_interconnect_0_rsp_mux_001
		port map (
			clk                 => avl_clk_out_clk_clk,                          --       clk.clk
			reset               => cpu_inst_reset_n_reset_bridge_in_reset_reset, -- clk_reset.reset
	...
	avalon_st_adapter : component ddr3_s0_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_001 : component ddr3_s0_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_002 : component ddr3_s0_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
	...
	avalon_st_adapter_003 : component ddr3_s0_mm_interconnect_0_avalon_st_adapter
		generic map (
			inBitsPerSymbol => 34,
			inUsePackets    => 0,
			inDataWidth     => 34,
...
end architecture rtl; -- of ddr3_s0_mm_interconnect_0
