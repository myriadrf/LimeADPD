...
architecture rtl of ddr3_s0 is
	...
	component ddr3_s0_mm_interconnect_0 is
		port (
	...
	end component ddr3_s0_mm_interconnect_0;

	component ddr3_s0_irq_mapper is
		port (
			clk        : in  std_logic                     := 'X'; -- clk
			reset      : in  std_logic                     := 'X'; -- reset
			sender_irq : out std_logic_vector(31 downto 0)         -- irq
		);
	end component ddr3_s0_irq_mapper;
...
begin
	...
	mm_interconnect_0 : component ddr3_s0_mm_interconnect_0
		port map (
	...
	irq_mapper : component ddr3_s0_irq_mapper
		port map (
			clk        => avl_clk,                       --       clk.clk
...
end architecture rtl; -- of ddr3_s0
