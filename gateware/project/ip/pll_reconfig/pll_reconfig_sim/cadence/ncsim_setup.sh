...
# ACDS 16.1 200 win32 2018.02.08.14:16:43
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work pll_reconfig -cdslib ./cds_libs/pll_reconfig.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_reconfig.vhd"                                                                                         
fi
