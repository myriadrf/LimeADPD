...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work pll_reconfig
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_reconfig.vhd"                                                 
fi
